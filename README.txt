...
Also check out:
> NFS Most Wanted - Extra Options (Build 4; Rev.04) - Features: https://youtu.be/cUKr6yCC_DA
> NFS Most Wanted - Extra Options - Build 5 Update: https://youtu.be/Wd1hGEEUmD0

------------------------------------------------------------------------------------------------------------
How To Compile:

! Before compiling, make sure you're using v1.3 speed.exe (5,75 MB (6.029.312 bytes)).
...
https://mega.nz/#!9chmRD4Q!1jSjN90rFirD_EHOBfrtlFpPwyQnFXR77JvifJSx4AY

Now you can compile the Extra Options. Just follow these steps:

1) Open "NFSMWExtraOptions\NFSMWExtraOptions.vcxproj" with Microsoft Visual Studio 2015 (If you want to use it with an older version, just change the platform toolset setting.)
2) Look for the "Solution Explorer" panel. Locate "NFSMWExtraOptions" under "Solution "NFSMWExtraOptions" (1 project)".
...
5) Now, copy it to your "NFS Most Wanted\scripts" folder. (Use Ctrl+C, Ctrl+V / Cmd+C, Cmd+V / Strg+C, Strg+V; Right-Click > Copy; via xcopy command on CMD; or how do you like it.)
6) Copy the NFSMWExtraOptionsSettings.ini from main folder into "NFS Most Wanted\scripts" folder, too.
7) Run NFSMW and see what happens. :)
...
https://github.com/nlgzrgn/NFSMWExOpts/issues

You can also send your improvements from GitHub as well: 
https://github.com/nlgzrgn/NFSMWExOpts/pulls
